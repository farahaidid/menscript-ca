			...
			<div class="bt-container mx-auto text-left row">
				<div class="col-md-6 w-100 pr-5 left-col">
					...
					<div class="frequentie">
						<h5 class="mb-2">2. Frequentie</h5>
						<div class="d-flex">
							<div class="pr-2">
								<button @click="freqSelected=0" :class="freqSelected==0&&'active'" class="w-100 mb-2">
									<span class="per">-10%</span>
									<span>iedere maand</span>
								</button>
								<button @click="freqSelected=1" :class="freqSelected==1&&'active'" class="w-100">
									<span class="per">-12%</span>
									<span>iedere 3 maanden</span>
								</button>
							</div>
							<div class="pl-2">
								<button @click="freqSelected=2" :class="freqSelected==2&&'active'" class="w-100 mb-2">
				...
				<div class="desteloverzicht col-md-6 w-100 pl-5">
					<h5 class="mb-4">Besteloverzicht</h5>
					<div class="vk-box br-black mb-3">
						...
						<div class="bt p-3">
							<p>Kortingscode? Vul die hier in ></p>
						</div>
